...
ARPACK_REAL=$(HOME)/sources/ARPACK/SRC/
SUPER_LU = $(HOME)/sources/SuperLU
...
CFLAGS= -g -Wall -I$(LIBDIR) -I$(ARPACK_DIR_2)  -I$(ARPACK_DIR) -I$(SUPER_LUH) -I$(MYCDIR) -I$(EIGEN_DIR) $(MKL_COMPILE) -I$(ARPACK_REAL)
#LDFLAGS=-I$(LIBDIR) -I$(MYDIR) 
LIBS=-larpack $(HOME)/myClibrary/utils.o $(SUPER_LU)/libsuperlu_3.0.a $(MKL_LINKLINE)
